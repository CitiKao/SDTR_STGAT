        ...
        json.dump(
            {
                ...
                "val_raw_metrics": filter_raw_metrics(val_raw_metrics, train_task),
                "val_raw_metrics_per_step": filter_raw_metrics_per_step(val_raw_metrics, train_task),
                "val_raw_metrics_report": filter_raw_metrics_report(val_raw_metrics, train_task),
